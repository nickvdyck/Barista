...
namespace Barista.MacOS.Utils
{
    ...
    {
        private static readonly Dictionary<string, string> _cssDictionary = new Dictionary<string, string>
        {
        ...
        {
            var hexString = color.StartsWith("#", System.StringComparison.CurrentCulture) ?
